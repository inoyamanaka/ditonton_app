...
// in ditonton/test/data/datasources/tv_series/db/database_tv_series_helper_test.dart.
...
import 'package:ditonton/data/datasources/db/database_helper_tv_series.dart'
    as _i2;
import 'package:ditonton/data/models/tv_series/tv_series_table.dart' as _i5;
...
class MockTvSeriesDatabaseHelper extends _i1.Mock
    implements _i2.TvSeriesDatabaseHelper {
  ...
  @override
  _i3.Future<int> insertWatchlist(_i5.TvSeriesTable? series) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertWatchlist,
          [series],
  ...
  @override
  _i3.Future<int> removeWatchlist(_i5.TvSeriesTable? series) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeWatchlist,
          [series],
