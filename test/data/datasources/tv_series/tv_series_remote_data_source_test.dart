...
void main() {
  ...
  group('get Popular TV Series', () {
    final tvSeriesList = TvSeriesResponse.fromJson(
            json.decode(readJson('dummy_data/tv_series/tv_popular.json')))
        .tvSeriesList;
    // print(readJson('dummy_data/tv_series/tv_popular.json'));
    test('should return list of TV Series Model when the response code is 200',
        () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/popular?$API_KEY')))
          .thenAnswer((_) async => http.Response(
                  readJson('dummy_data/tv_series/tv_popular.json'), 200,
                  headers: {
                    HttpHeaders.contentTypeHeader:
                        'application/json; charset=utf-8',
                  }));
  ...
  group('get Detail TV Series', () {
    int tId = 1;
    final tvSeriesList = TvSeriesDetailModel.fromJson(
        json.decode(readJson('dummy_data/tv_series/detail_tv_series.json')));
    // print(readJson('dummy_data/tv_series/tv_popular.json'));
    test('should return list of TV Series Model when the response code is 200',
        () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(
                  readJson('dummy_data/tv_series/detail_tv_series.json'), 200,
                  headers: {
                    HttpHeaders.contentTypeHeader:
                        'application/json; charset=utf-8',
                  }));
  ...
  group('search movies', () {
    final tSearchResult = TvSeriesResponse.fromJson(
            json.decode(readJson('dummy_data/tv_series/naruto_search.json')))
        .tvSeriesList;
    final tQuery = 'Naruto';
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
                  readJson('dummy_data/tv_series/naruto_search.json'), 200,
                  headers: {
                    HttpHeaders.contentTypeHeader:
                        'application/json; charset=utf-8',
                  }));
